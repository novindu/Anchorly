                                      ...
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          await widget.familyGroupRef!.update(
                                            ...
                                            multiAdultApproval:
                                                _model.multiAdultApproval,
                                            auditAccess: _model.auditAccess,
                                            signatureSharing:
                                                _model.signatureSharing,
                                          ));

                                          await widget.familyGroupRef!.update(
                                              createFamilyGroupsRecordData(
                                            multiAdultApproval: _model
                                                .permissionItemModel1
                                                .switchComponentModel
                                                .switchValue,
                                            auditAccess: _model
                                                .permissionItemModel2
                                                .switchComponentModel
                                                .switchValue,
                                            signatureSharing: _model
                                                .permissionItemModel3
                                                .switchComponentModel
                                                .switchValue,
                                          ));
                                        },
